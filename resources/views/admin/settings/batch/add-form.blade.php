                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control @error('student_capacity') is-invalid @enderror" name="student_capacity" value="{{ old('student_capacity') }}" id="StudentCapacity" placeholder="Write  Student Capacity Here." required>
