    ...
    <section class="container-fluid">
        ...
        @include('admin.includes.alert')
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <h4 class="text-center font-weight-bold font-italic mt-3">Student Registation Form</h4>
                    </div>
                </div>
                 ...
                 <form action="{{ route('student-save') }}" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" name="student_name" class="form-control col-sm-8" placeholder="Student Name" value="" id="studentName" required autofocus>
...
{{--                     <div class="form-group col-md-6 mb-3">
 ...
 {{--                    <div class="form-group col-md-6 mb-3">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" name="sms_mobile" class="form-control col-sm-8" id="smsMobile" placeholder="8801XXXXXXXXX" value="" minlength="9" maxlength="15" required>
                        <span class="text-danger"></span>
                    </div>
