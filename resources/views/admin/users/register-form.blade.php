...
<section class="container-fluid">
    <div class="row content registation-form">
        <div class="col-12 pl-0 pr-0">
            ...
            <form method="POST" action="{{ route('users.store') }}" autocomplete="off" class="form-inline">
                 @csrf

                <div class="form-group col-12 mb-3">
                    <label for="role" class="col-sm-3 col-form-label text-right">Role</label>

                    <select name="role" class="form-control col-sm-9 @error('role') is-invalid @enderror" id="role">
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="name" type="text" class="col-sm-9 form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Name" required autocomplete="name" autofocus>
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="password-confirm" type="password" class="col-sm-9 form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Confirm Password" required>
